...
class SeatAlocationUserInfoView extends React.Component {
    ...
    getSeatInfoData() {
        ...
        axios(Constants.API_URLS.GET_SEAT_INFO_BY_EMPID + userInfo.empId, {
            ...
            this.setState({ isLoading: false, hasAllowcatedSeat: ! isEmpty( result.data ), userInfo: {
                ...this.state.userInfo,
    ...
    render() {
        ...
        const { userInfo, isLoading, hasAllowcatedSeat } = this.state;

        return (
            <div className='container-fluid seat'>
                <div className='row'>
                    <div className='col col-12'>
                        <h2 className="seat__title">{ hasAllowcatedSeat ? 'Update' : '' } Seat Allocation</h2>
                    </div>
                </div>
