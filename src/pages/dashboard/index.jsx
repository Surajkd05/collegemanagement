...
class Dashboard extends React.Component {
    ...
    render() {
        const { isRoomScreen, hasAllowcatedSeat, userInfo, actionHasalocated } = this.state;
        return (
            <>
                <DashboardView />
                { isRoomScreen ?
                <SeatAllocation { ...{ hasAllowcatedSeat, userInfo, actionHasalocated } } />
                : <SeatAllocationUserInfo { ...{ showSeatScreen: this.showSeatScreen, hasAllowcatedSeat } } /> }
            </>
        )
    }
}
