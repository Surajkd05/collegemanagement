const API_ZOHO_PATH = 'http://localhost:8080';
const API_HOST_PATH = 'http://localhost:8080/college';
const Constants = {
    TEST: 'TEST',
    API_URLS: {
		REGISTER_ADMIN:`${API_HOST_PATH}/register/admin/`,
		REGISTER_STUDENT:`${API_HOST_PATH}/register/student/`,
		REGISTER_EMPLOYEE:`${API_HOST_PATH}/register/employee/`,
		CONFIRM_STUDENT_ACCOUNT:`${API_HOST_PATH}/register/confirm-account/`,
		RESEND_ACTIVATION:`${API_HOST_PATH}/register/resend-activation/`,
        LOGIN: `${API_ZOHO_PATH}/oauth/token/`,
