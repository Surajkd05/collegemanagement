    ...
    return (
        <div className='container-fluid employeeContainer'>
            <div className='row'>
                ...
                <input type="text" className="form-control" placeholder="Search employee..." onChange={search} />
                </div>
            </div>
            <div className='row'>
                                ...
                                {(rowsPerPage > 0
                                    ...
                                    <TableRow key={index} style={index % 2 ? { background: "#D3D3D3" } : { background: "white" }}>                                    
                                        ...
                                        <TableCell align="center">
                                            <button className='btn btn-sm btn-secondary'  onClick={() => addSeat(row.name)}>Click Me</button>
                                        </TableCell>
                                    </TableRow>
                                ))}
